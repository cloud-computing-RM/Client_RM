...
import { RunRecord } from "./records/RecordCard";
...
export function EditRecordModal({ isOpen, onClose, onUpdate, record }: EditRecordModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>러닝 기록 수정</DialogTitle>
        </DialogHeader>
